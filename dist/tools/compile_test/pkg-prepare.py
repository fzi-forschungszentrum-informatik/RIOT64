...
def prepare_all():
    ...
    for folder in sorted(app_folders):
        print('Preparing all applications in: {}'.format(colorize_str(folder, Termcolor.blue)))
            ...
            try:
                ...
                if returncode == 0:
                    ...
                    if not failed_with_output:
                        print(colorize_str('\t\tmake pkg-prepare error!', Termcolor.red))
